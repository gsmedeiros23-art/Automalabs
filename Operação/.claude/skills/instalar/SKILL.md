...
name: instalar
description: >
  Instala o Automalabs no negócio do usuário. Entrevista sobre empresa, tom de voz,
  ...
  pedir explicitamente "rodar /instalar", "instalar o Automalabs", "primeiro setup".
---

# /instalar — Instalação inicial do Automalabs
...
Conferir o nome da pasta atual (`basename "$(pwd)"`). Se for `Automalabs`, `Automalabs`, `Automalabs-main`, `Automalabs-main` ou variação genérica:

> "Notei que a pasta atual ainda tem nome genérico ('<nome-atual>'). O ideal é a pasta ter o nome do seu negócio, não 'Automalabs'. Quando terminarmos o setup, te lembro de renomear (é rápido — fechar VS Code, renomear a pasta no Finder/Explorer, abrir de novo). Bora seguir?"
...
> "Pronto. O Automalabs já te conhece.
>
